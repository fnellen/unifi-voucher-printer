...
Der UniFi Voucher Printer ist eine Webanwendung, die primär das Erstellen und Drucken von Wifi Zugangscodes für ein UniFi Gäste-Netzwerk handhabt. Die Anwendung soll einfach, intuitiv und ohne technische Vorkenntnisse benutzt werden können. Sie wurde für das Hotel Oca Bianca in Como (CO) Italien entwickelt. 
Die Anwendung stellt eine Alternative zu dem bereits durch die UniFi OS Konsole zur Verfügung gestellen Webinterfaces zum Erstellen von Vouchern dar. Dieses Interface erfordert grundlegende Kenntnisse über Netzwerke und bietet keine Möglichkeit die Voucher individuell auf kleinen Zetteln für die Gäste zu drucken.

Die Anwendung soll Eingaben des Nutzers mittels eines responsive Webinterface entgegenehmen und einen Voucher mit einem Etikettendrucker ausdrucken können. 
Zu den Eingaben zählen die Zimmernummer, die Anzahl der Gäste und die Aufenthaltsdauer der Gäste.

Sie soll nur innerhalb des internen Netzwerkes erreichbar sein. 
